...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="{{url('public/css/style.css?').time()}}" rel="stylesheet"> 
    </head>
    <body>
    ...
    <script type='text/javascript'>
        $(document).ready(function(e){
            ...
            $('.main-album').click(function(e) {
                ...
                console.log(e_no);
                var route = "{{ route('album.show',['album' => ':id' ]) }}";
